...
function generate-lockfile {
    docker run --rm \
        ...
        public.ecr.aws/lambda/python:3.11 \
            ...
            pip install uv && \
            uv pip compile pyproject.toml --output-file=requirements.txt --prerelease=allow"
}
...
function test:ci {
    INSTALLED_PKG_DIR="$(python -c 'import linkedin_post_explorer; print(linkedin_post_explorer.__path__[0])')"
